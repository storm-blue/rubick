...
func Test_splitSimpleConditionExpression(t *testing.T) {
	tests := []struct {
		name         string
		expression   string
		wantLeft     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotLeft, gotRight, gotOperator, err := splitSimpleConditionExpression(tt.expression)
			if (err != nil) != tt.wantErr {
				t.Errorf("splitSimpleConditionExpression() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if gotLeft != tt.wantLeft {
				t.Errorf("splitSimpleConditionExpression() gotLeft = %v, want %v", gotLeft, tt.wantLeft)
			}
			if gotRight != tt.wantRight {
				t.Errorf("splitSimpleConditionExpression() gotRight = %v, want %v", gotRight, tt.wantRight)
			}
			if gotOperator != tt.wantOperator {
				t.Errorf("splitSimpleConditionExpression() gotOperator = %v, want %v", gotOperator, tt.wantOperator)
			}
		})
	}
}
...
func Test_parseSimpleCondition(t *testing.T) {
	tests := []struct {
		name       string
		expression string
		want       conditions.Condition
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := parseSimpleCondition(tt.expression)
			if (err != nil) != tt.wantErr {
...
func Test_unwrapIfNeeded(t *testing.T) {
	tests := []struct {
		name       string
		expression string
		want       string
