...
func TestSearchResources_MAIN(t *testing.T) {
	got, _, _ := SearchResources("/Users/edy/kubeconfigs/kubeconfig-production", "deployment", "alivia2", []string{})
...
func TestParseLine(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:          "TEST3",
			line:          "habitat              habitat.develop2.meetwhale.com     habitat2.develop.meetwhale.com                        10.200.2.90,10.200.2.91,10.200.2.92,10.200.2.93,10.200.2.95   80        391d",
			wantNamespace: "habitat",
			wantName:      "habitat.develop2.meetwhale.com",
		},
	}
